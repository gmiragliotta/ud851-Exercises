...
public class NotificationUtils {
    private static final int WATER_REMINDER_PENDING_INTENT_ID = 48;
    public static final int WATER_REMINDER_NOTIFICATION_ID = 67;
    private static final String WATER_REMINDER_NOTIFICATION_CHANNEL_ID = "channel_0";
    private static final String WATER_REMINDER_NOTIFICATION_CHANNEL_NAME = "Water Reminder";
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel mChannel = new NotificationChannel(
                    ...
                    WATER_REMINDER_NOTIFICATION_CHANNEL_NAME,
        ...
        notificationBuilder.setContentTitle(context.getString(R.string.charging_reminder_notification_title));
        notificationBuilder.setContentText(context.getString(R.string.charging_reminder_notification_body));
        ...
        mNotificationManager.notify(WATER_REMINDER_NOTIFICATION_ID, notificationBuilder.build());
    }
    ...
    private static PendingIntent contentIntent (Context context) {
        ...
        Intent startingMainActivityIntent = new Intent (context, MainActivity.class);
    ...
    private static Bitmap largeIcon (Context context) {
        ...
        return BitmapFactory.decodeResource(contextResources, R.drawable.ic_local_drink_black_24px);
    }
