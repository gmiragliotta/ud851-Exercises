...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            int code = stickyIntent.getIntExtra(BatteryManager.EXTRA_STATUS, -1);
            boolean isCharging = BatteryManager.BATTERY_STATUS_CHARGING == code ||
                    BatteryManager.BATTERY_STATUS_FULL == code;
